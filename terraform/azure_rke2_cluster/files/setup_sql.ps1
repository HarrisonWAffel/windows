...
# of the SQL server via the 'set.exe' binary.
...
Configuration SQLInstall
{
    ...
    (
        ...
        [Parameter()]
        [String]
        `$LocalAccount = "`$env:computername\adminuser",
...
SQLInstall -SqlServerAdminName "$adminUser" -SqlInstallCredential $SqlSvcCred -SqlAdministratorCredential $SqlSvcCred -SqlServiceCredential $SqlSvcCred -SqlAgentServiceCredential $SqlSvcCred -ConfigurationData $cd
